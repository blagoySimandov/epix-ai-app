		...
		<main className="min-h-screen bg-background">
			<div className="mx-auto max-w-[390px] px-4 pt-10 pb-32 flex flex-col gap-8">
				...
				<div className="flex items-center gap-3">
					<Link to="/" className="p-2 -ml-2 text-muted-foreground interactive-delight">
						<ArrowLeft size={20} />
					</Link>
				...
				<div className="glass-card p-6 rounded-[2.5rem] border border-white/5 flex flex-col gap-6 relative overflow-hidden">
					...
					<div className="flex justify-between items-center relative z-10">
						...
						<div className="flex flex-col items-end gap-1">
							...
							<span className={`text-sm font-bold ${
								domain.risk === "red" ? "text-rose-400" : 
								domain.risk === "yellow" ? "text-yellow-400" : "text-green-glow"
							}`}>
					...
					<div className="flex justify-between text-[10px] text-muted-foreground uppercase font-bold tracking-wider relative z-10 px-2">
						<div className="flex flex-col gap-1">
							...
							<span className="text-foreground text-xs">{domain.geneticRisk}%</span>
						</div>
						<div className="flex flex-col items-end gap-1">
							<span>Epigenetic Load</span>
							<span className="text-teal text-xs">{domain.geneticActivation}%</span>
						</div>
					</div>
				</div>
				...
				<div className="flex flex-col gap-4">
					<div className="flex items-center justify-between px-1">
						<h2 className="text-lg font-bold tracking-tight">Disease Propensity</h2>
				...
				<div className="p-4 rounded-3xl bg-teal/5 border border-teal/20">
					<p className="text-xs text-teal leading-relaxed font-medium">
						...
						these conditions represent your primary preventive focus areas for the next 6 months.
					</p>
				</div>
			</div>
		</main>
